...
data class CallModel(val callId: Int, val name: String, val description: String, val author: String, val authorId: Int,
    ...
    override fun toString(): String {
        return "CallModel(call_id = $callId, name = '$name', description = '$description', author = '$author', author_id = $authorId, phone = $phone, price = $price, currency = '$currency')"
    }
}
